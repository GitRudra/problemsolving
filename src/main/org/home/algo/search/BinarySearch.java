...
public class BinarySearch {
     ...
     * As Bishu is weak in mathematics, help him to count the number of soldiers that he can kill in each round
     * and total sum of their powers.
     *
     * 1<=N<=10000
     *
     ...
     * @param bishuStrength
     */
    public void getBishuSoldierValue(int[] soldiersvalue, int bishuStrength){
