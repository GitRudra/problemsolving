 ...
 * The heap can behave like max of min heap based on the
 * comparator provided during construction of the object
 *
 * @param <E>
 */
public class Heap<E> {
     ...
     * @param comp
     */
    public Heap(int heapSize, Comparator comp) {
        this.heapSize = heapSize;
        this.comparator = comp;
        heapElements = new ArrayList<>(heapSize);
        currentSize = 0;
    }
