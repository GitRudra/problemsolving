...
class DrawTree extends JPanel{
    ...
    public void DrawNode(Graphics g,LevelOrderTreeNode n,int w,int h,int q){
        g.setFont(new Font("Tahoma", Font.BOLD, 20));
    ...
    public void DrawTree(Graphics g, int StartWidth, int EndWidth, int StartHeight, int Level, LevelOrderTreeNode node) {
